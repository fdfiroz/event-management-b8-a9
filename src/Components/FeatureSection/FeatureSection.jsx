    ...
    const features = [
        {
            ...
            title: "Quick setup",
            desc: "Easily set up your project with one command."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: "All events are secured with a token."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Big Event Manage",
            desc: "Manage big events with ease."
        },
    ]
  return (
    <section className="relative py-28 bg-gray-900">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 text-gray-300 justify-between gap-24 lg:flex md:px-8">
                <div className="max-w-xl" data-aos="fade-right">
                    ...
                    <p className="mt-3">
                        We are a team of dedicated professionals who are passionate about building and designing the best event.
                    </p>
                </div>
